...
$files = $pdo->query("SELECT * FROM english_worksheet ORDER BY id DESC")->fetchAll();
...
<head>
  ...
  <title>Albushra World | English Worksheets</title>
  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      overflow-x: hidden;
      background-image: url("https://images.pexels.com/photos/6725360/pexels-photo-6725360.jpeg");
    ...
    /* download button - BASE STYLE (emerald green) */
    ...
    /* view button - الآن فعال ويفتح الملف */
    .content a.view-btn {
      display: inline-block;
      padding: 8px 22px;
      background: #3498db;
    ...
    .content a.view-btn:hover {
      transform: scale(1.05);
      background: #2c7ab1;
      box-shadow: 0 6px 14px rgba(0, 0, 0, 0.2);
    }

    /* unique hover colors for each card download button */
    .grid .card:nth-child(1) .content a.download-btn:hover {
      background: #f39c12 !important;
      box-shadow: 0 8px 18px rgba(243, 156, 18, 0.4);
    }

    .grid .card:nth-child(2) .content a.download-btn:hover {
      background: #e74c3c !important;
      box-shadow: 0 8px 18px rgba(231, 76, 60, 0.4);
    }

    .grid .card:nth-child(3) .content a.download-btn:hover {
      background: #9b59b6 !important;
      box-shadow: 0 8px 18px rgba(155, 89, 182, 0.4);
    }

    .grid .card:nth-child(4) .content a.download-btn:hover {
...
<body>
  ...
  <header class="navbar">
    ...
    <nav id="desktopNav">
      ...
      <!-- تم تعديل رابط Worksheets لفتح المودال -->
      <a href="#" class="worksheets-trigger">📄 Worksheets</a>
      <!-- NEW Fun Presentations link -->
  ...
  <div class="mobile-nav" id="mobileNavMenu">
    ...
    <a href="index.php">🏠 Home</a>
    <!-- تم تعديل رابط Worksheets هنا أيضاً -->
    <a href="#" class="worksheets-trigger">📄 Worksheets</a>
    <!-- NEW Fun Presentations link in mobile menu -->
    <a href="#" class="presentations-trigger">🎭 Fun Presentations</a>
    <a href="online_games.php" class="game-link-trigger">🎮 Online Games</a>
    <a href="english_flashcards.php">📘 English Flashcards</a>
    <a href="math_flashcards.php">🧮 Math Flashcards</a>
  ...
  <!-- ========== ENGLISH WORKSHEETS CONTENT ========== -->
  <div class="sightwords-section">
    <div class="heading-wrapper">
      <div class="section-heading">📖 English Worksheets</div>
    </div>
    <div class="grid">
      <?php foreach ($files as $index => $file): ?>
        <?php
        $img = $images[$index % count($images)]; // تكرار الصور تلقائي
        ...
        <div class="card">
          ...
          <div class="content">
            ...
            <div class="button-group">
              <a href="download_files.php?table=english_worksheet&id=<?= $file['id'] ?>" class="download-btn">⬇ Download</a>
              <!-- زر View: فعال الآن ويفتح الملف في نافذة جديدة -->
              <a href="view_english_sheet.php?id=<?= $file['id'] ?>" class="view-btn" target="_blank"> View</a>
              <!-- زر Download: تحميل الملف -->
            </div>
          </div>
        </div>
      <?php endforeach; ?>
  ...
  <script>
    ...
    // Close mobile menu after clicking any link inside
    ...
    // ========== GAME MODAL LOGIC ==========
    const gameLinks = document.querySelectorAll('a[href="online_games.php"]');
