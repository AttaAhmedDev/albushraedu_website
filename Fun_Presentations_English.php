...
$files = $pdo->query("SELECT * FROM english_presentation ORDER BY id DESC")->fetchAll();
  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      overflow-x: hidden;
      background-image: url("https://images.pexels.com/photos/33997126/pexels-photo-33997126.jpeg");
...
<body>
  ...
  <div class="sightwords-section">
    <div class="heading-wrapper">
      <div class="section-heading">📖 Fun Presentations English</div>
    </div>
    <div class="grid">
        ...
        <div class="card">
          ...
          <div class="content">
            <div class="action-buttons">
              <a href="download_files.php?table=english_presentation&id=<?= $file['id'] ?>"> Download</a>
            </div>
          </div>
        </div>
      <?php endforeach; ?>
