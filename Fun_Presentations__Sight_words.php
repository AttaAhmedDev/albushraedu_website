...
$files = $pdo->query("SELECT * FROM sight_presentation ORDER BY id DESC")->fetchAll();
  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      overflow-x: hidden;
      background-image: url("https://images.pexels.com/photos/19148690/pexels-photo-19148690.jpeg");
...
<body>
  ...
  <div class="sightwords-section">
    <div class="heading-wrapper">
      <div class="section-heading">📖 Fun Presentations Sight words</div>
    </div>
    <div class="grid">
        ...
        <div class="card">
          ...
          <div class="content">
            <div class="action-buttons">
              <a href="download_files.php?table=sight_presentation&id=<?= $file['id'] ?>"> Download</a>
            </div>
          </div>
        </div>
      <?php endforeach; ?>
