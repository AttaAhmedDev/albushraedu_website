...
$files = $pdo->query("SELECT * FROM math_worksheet ORDER BY id DESC")->fetchAll();
...
<head>
  ...
  <style>
    ...
    * {
    ...
    .grid .card:nth-child(1) .content a:not(.view-link):hover {
      background: #f39c12 !important;
      box-shadow: 0 8px 18px rgba(243, 156, 18, 0.4);
    }

    .grid .card:nth-child(2) .content a:not(.view-link):hover {
      background: #e74c3c !important;
      box-shadow: 0 8px 18px rgba(231, 76, 60, 0.4);
    }

    .grid .card:nth-child(3) .content a:not(.view-link):hover {
      background: #9b59b6 !important;
      box-shadow: 0 8px 18px rgba(155, 89, 182, 0.4);
    }

    .grid .card:nth-child(4) .content a:not(.view-link):hover {
...
<body>
  ...
  <header class="navbar">
    ...
    <nav id="desktopNav">
      ...
      <a href="#" class="worksheets-link-trigger">📄 Worksheets</a>
  ...
  <div class="sightwords-section">
    <div class="heading-wrapper">
      <div class="section-heading">📖 Math Worksheets</div>
    </div>
    <div class="grid">
        ...
        <div class="card">
          ...
          <div class="content">
            ...
            <div class="action-buttons">
              <a href="download_files.php?table=math_worksheet&id=<?= $file['id'] ?>" class="download-btn">⬇ Download</a>
              <!-- زر View أصبح رابطًا فعّالاً يفتح الملف في نافذة جديدة -->
              <a href="view_math_sheet.php?id=<?= $file['id'] ?>" class="view-link" target="_blank"> View</a>
            </div>
          </div>
        </div>
      <?php endforeach; ?>
