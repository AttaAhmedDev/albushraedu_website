...
$files = $pdo->query("SELECT * FROM sight_worksheet ORDER BY id DESC")->fetchAll();
...
<head>
  ...
  <title>Albushra World | Sight Words Worksheets</title>
  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      overflow-x: hidden;
      background-image: url("https://images.pexels.com/photos/8535234/pexels-photo-8535234.jpeg");
    ...
    /* unique hover colors for each card download button (optional) */
...
<body>
  ...
  <!-- ========== SIGHT WORDS WORKSHEETS CONTENT ========== -->
  <div class="sightwords-section">
    <div class="heading-wrapper">
      <div class="section-heading">📖 Sight Word Worksheets</div>
    </div>
    <div class="grid">
      <?php foreach ($files as $index => $file): ?>
        ...
        // مسار الملف للمعاينة (افترض أن $file['file_path'] يحتوي على مسار الملف الكامل)
        ...
        <div class="card">
          ...
          <div class="content">
            ...
            <div class="button-group">
              <!-- زر View: يفتح الملف في نافذة جديدة -->
              <a href="download_files.php?table=sight_worksheet&id=<?= $file['id'] ?>" class="download-btn">⬇ Download</a>
              <a href="view_sight_sheet.php?id=<?= $file['id'] ?>" target="_blank" class="view-btn"> View</a>
            </div>
          </div>
        </div>
      <?php endforeach; ?>
  ...
  <script>
    ...
    gameLinks.forEach(link => link.addEventListener('click', openGameModal));
    ...
    document.addEventListener('keydown', (e) => {
      if (e.key === 'Escape' && modal && modal.style.display === 'flex') closeGameModal();
    });
