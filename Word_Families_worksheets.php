...
$files = $pdo->query("SELECT * FROM word_worksheet ORDER BY id DESC")->fetchAll();
...
<head>
  ...
  <title>Albushra World | Word Families Worksheets</title>
  ...
  <style>
    ...
    * {
    ...
    body {
      ...
      overflow-x: hidden;
      background-image: url("https://images.pexels.com/photos/35782382/pexels-photo-35782382.jpeg");
...
<body>
  ...
  <!-- ========== WORD FAMILIES WORKSHEETS CONTENT ========== -->
  <div class="sightwords-section">
    <div class="heading-wrapper">
      <div class="section-heading">📖 Word Families worksheets</div>
    </div>
    <div class="grid">
        ...
        <div class="card">
          ...
          <div class="content">
            ...
            <div class="action-buttons">
              <a href="download_files.php?table=word_worksheet&id=<?= $file['id'] ?>" class="download-btn">⬇ Download</a>
              <a href=" view_word_sheet.php?&id=<?= $file['id'] ?>" target="_blank" class="view-btn"> View</a>
            </div>
          </div>
        </div>
      <?php endforeach; ?>
